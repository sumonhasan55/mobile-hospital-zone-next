...
const VideoPage = () => {
    ...
    return (
      <div>
        <h1 className="  ml-16 lg:ml-0 text-center text-2xl my-10 lg:text-5xl lg:my-20 text-primary font-extrabold">Videos</h1>
       <div className=" mx-auto px-2 lg:grid grid-cols-3  gap-12   ml-16 lg:ml-10 items-center ">
